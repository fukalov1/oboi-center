...
<div id="app" class="wrapper">
    ...
    <div  id="transform-side4" class="sect4">
        <div id="s4" class="container">
            ...
            <div class="row">
                ...
                <div class="item">
                    <div class="image">
                        <img src="images/s4i3.jpg" alt="">
                        <div class="title" style="padding-left: 0px;"></div>
                    </div>
                </div>
                <div class="item">
                    <div class="image">
                        <img src="images/s4i4.jpg" alt="">
                        <div class="title" style="padding-left: 0px;"></div>
                    </div>
                </div>
                <div class="item">
                    <div class="image">
                        <img src="images/s4i5.jpg" alt="">
                        <div class="title" style="padding-left: 0px;"></div>
                    </div>
                </div>
                <div class="item">
                    <div class="image">
                        <img src="images/s4i6.jpg" alt="">
                        <div class="title" style="padding-left: 0px;"></div>
                    </div>
                </div>
                <div class="item">
                    <div class="image">
                        <img src="images/s4i7.jpg" alt="">
                        <div class="title" style="padding-left: 0px;"></div>
                    </div>
                </div>
                <div class="item">
                    <div class="image">
                        <img src="images/s4i8.jpg" alt="">
                        <div class="title" style="padding-left: 0px;"></div>
                    </div>
                </div>
                <div class="item">
                    <div class="image">
                        <img src="images/s4i9.jpg" alt="">
                        <div class="title" style="padding-left: 0px;"></div>
                    </div>
                </div>
                <div class="item">
                    <div class="image">
                        <img src="images/s4i10.jpg" alt="">
                        <div class="title" style="padding-left: 0px;"></div>
                    </div>
                </div>
                <div class="item">
                    <div class="image">
                        <img src="images/s4i11.jpg" alt="">
                        <div class="title" style="padding-left: 0px;"></div>
                    </div>
                </div>
                <div class="item">
                    <div class="image">
                        <img src="images/s4i12.jpg" alt="">
                        <div class="title" style="padding-left: 0px;"></div>
                    </div>
                </div>
        ...
        <div id="scroll-fly-right2">
            <div id="s6" class="sect6">
                <div class="container">
                    ...
                    <div class="row">
                        <div class="item">
                            <div class="img"><img src="images/s6i4.jpg" alt=""></div>
                            <div class="text">Плинтусы</div>
                        </div>
                        <div class="item">
                            <div class="img"><img src="images/s6i2.jpg" alt=""></div>
                            <div class="text">Люстры</div>
                        </div>
                        <div class="item">
                            <div class="img"><img src="images/s6i1.jpg" alt=""></div>
                            <div class="text">Картины</div>
                        </div>
                        <div class="item">
                            <div class="img"><img src="images/s6i3.jpg" alt=""></div>
    ...
    <div id="s-map" class="social">
        ...
        <div class="social-row">
            <a href="https://vk.com/oboi_centre" class="social__btn" target="_blank"><img src="images/icon-soc-vk.png" width="70" height="70" alt="image"></a>
            <a href="https://www.instagram.com/oboi_centre/?r=nametaghttps://instagram.com/oboi_centre?r=nametag" class="social__btn" target="_blank"><img src="images/icon-soc-inst.png" width="70" height="70" alt="image"></a>
        </div>
        <br/>
